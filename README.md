<div align="center">
  <img src="public/icon.svg" alt="Humin Logo" width="150" />
  <h1>Humin</h1>
  <p><strong>Smart Employee Data & Reporting</strong></p>
  <p>
    <a href="https://humin.vercel.app" target="_blank"><img src="https://vercel.com/button" alt="Deploy with Vercel"/></a>
  </p>
</div>
...
**URL: [https://humin.vercel.app](https://humin.vercel.app)**
...
| Category      | Technology                                                              |
| ------------- | ----------------------------------------------------------------------- |
| **Framework**   | [Next.js 16](https://nextjs.org/) (App Router) for SSR and performance. |
...
1.  Clone the repository:
    ```sh
    git clone https://github.com/m3h3d1ha2an/humin.git
    cd humin
    ```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/m3h3d1ha2an/humin/issues).
